...
<html lang="en">
            ...
            <div class="row tm-content-row">
                <div class="col-sm-6 offset-3 justify-content-center tm-block-col">
                    <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
                        <h2 class="tm-block-title">List of Categories</h2>
                        <c:if test="${mess!=null }">
                                    ...
                                    <tbody >
                                        <c:forEach items="${listC}" var="c">
                                            <tr>
                                                ...
                                                <td><input type="hidden" name="cid" value="${c.cid}"/>${c.name}</td>                                                 

                                                <td>
                                                    <a href="loadCate?cid=${c.cid}" class="tm-product-delete-link">
                                                        <i class="bi bi-pencil-square tm-product-delete-icon"></i>
                                                    </a>
                                                    <a id="deleteButton" onclick="confirmDelete('${c.cid}')" class="tm-product-delete-link">
    ...
    function confirmDelete(cid) {
        ...
        xhr.open("GET", "deleteCate?cid=" + cid, true);
        xhr.send();
