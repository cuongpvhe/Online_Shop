...
public class EmailHandler {
    ...
    public static void sendEMail(String toEmail, String subject, String text) {
        try {
            final String fromEmail = (String) new InitialContext().lookup("java:comp/env/email");
            final String password = (String) new InitialContext().lookup("java:comp/env/password");
