                    ...
                    <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
                        ...
                        <div class="row tm-edit-product-row">
                            <div class="col-xl-6 col-lg-6 col-md-12">
                                <form action="addProductSales" method="post" class="tm-edit-product-form" enctype="multipart/form-data">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-12 mx-auto mb-4">
                                ...
                                <div class="tm-product-img-edit mx-auto col-sm-6">
                                    <img id="displayImage" src="" alt="Product image" class="img-fluid d-block mx-auto">
