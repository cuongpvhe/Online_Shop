 ...
 */
@MultipartConfig
@WebServlet(name = "EditProductSales", urlPatterns = {"/editProductSales"})
public class EditProductSales extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int id, categoryId, brandId, status;
        double price;
        ...
        try {
            ...
            if (n.length() == 0) {
                ...
                request.getRequestDispatcher("loadProductSales").forward(request, response);
                ...
                sd.updateProduct(name, price, description, filename, categoryId, mid, status, id);
