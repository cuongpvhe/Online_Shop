                        ...
                        <div class="containerFeedback" style="display: flex; flex-direction: column; gap: 10px; padding: 20px;">
                            ...
                            <div class="rate" style="border-bottom: 1px solid #e5e5e5;">
                                ...
                                <c:forEach var="i" begin="1" end="${starCount}">
                                    <i style="color: #f7941d; font-size: 15px;" class="fas fa-star fa-sm"></i>
                                </c:forEach>
                            ...
                            <div class="reviewFeedbackTitle">
                                ...
                                <p style="font-size: 15px;">${listFb.title}</p>
                            </div>
                            <div>
                                <span style="font-size: 15px; font-weight: 600">Your Feedback</span>
                                <p style="font-size: 15px;">${listFb.desFeedback}</p>
                            </div>
                            ...
                            <span style="font-size: 15px; font-weight: 600">Date Create</span>
                            <p style="font-size: 15px;">${listFb.fullnameFeedback} - ${listFb.date}</p>

                            <a href="editfeedback?aid=${listFb.aid}&pid=${listFb.pid}&oid=${oid}&fid=${listFb.fid}"><button style="width: 100%" class="btn btn-primary mb-3" type="submit">Edit</button></a>
                            <a href="delete?oid=${oid}&fid=${listFb.fid}"><button style="width: 100%; background-color: red; color: white;" class="btn btn-danger" type="submit">Delete</button></a>
                        </div>
                    </div>
