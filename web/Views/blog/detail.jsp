<%-- 
    Document   : detail
    Created on : 08-10-2023, 11:11:15
    Author     : phanh
--%>

<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<jsp:useBean class="dal.AccountDAO" id="aDao"/>
<jsp:useBean class="dal.BlogDAO" id="bDao"/>
...
<html lang="zxx">
    ...
    <body>
        ...
        <c:set var="updateBy" value="${aDao.getAccountById(data.updateBy)}" />
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-9 text-center">
                        <div class="blog__hero__text">
                            <h2>${data.title}</h2>
                            <ul>
                                <li>By: ${updateBy.fullName}</li>
                                <li>Date: ${data.createDate}</li>
                                <!--<li>8 Comments</li>-->
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-8">
                        <div class="blog__details__content">
                            ...
                            <div class="blog__details__btns">
                                <div class="row">
                                    <c:set var="prevBlog" value="${bDao.checkAroundBlogValid(data.id, 'prev')}" />
                                    <c:set var="nextBlog" value="${bDao.checkAroundBlogValid(data.id, 'next')}" />
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <c:if test="${prevBlog != null}">
                                            <a href="blogDetail?id=${prevBlog.id}" class="blog__details__btns__item">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <c:if test="${nextBlog != null}">
                                            <a href="blogDetail?id=${nextBlog.id}" class="blog__details__btns__item blog__details__btns__item--next">
