...
//            rs = ps.executeQuery();
    ...
    public List<Manager> getManger() {
        ...
        String query = "  select distinct a.Id, a.Fullname\n"
                + " from Account a\n"
                + " where a.roleid = 3";
...
//            rs = ps.executeQuery();
    ...
    public void updateProduct(String name, double price, String description,
            String imageUrl, int category, int brand, int manager,int status, int id) {
    ...
    public static void main(String[] args) {
        ...
        //dao.addProduct("aaa", 12, "ccc", "adad", 1, 1, 1, 1);
