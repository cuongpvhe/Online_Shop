...
<html lang="en">
    <head>
        ...
        <title>List Size of Products</title>
        <link
            rel="stylesheet"
                                    ...
                                    <tbody >
                                        <c:forEach items="${size}" var="s">
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="loadSalesSizeDetail?pid=${product.id}&sizeId=${s.id}" class="tm-product-delete-link">
                                                        <i class="bi bi-pencil-square tm-product-delete-icon"></i>
                                                    </a>
                                                    <a id="deleteButton" onclick="confirmDelete('${p.id}, ${s.id}')" class="tm-product-delete-link">
    ...
    <script>
                                                        function confirmDelete(pid, sid) {
                                                            if (confirm('Bạn có chắc chắn muốn xóa không?')) {
                                                                ...
                                                                xhr.open("GET", "deleteSizeSales?pid=" + pid+ "& sizeId=" +sid, true);
                                                                xhr.send();
